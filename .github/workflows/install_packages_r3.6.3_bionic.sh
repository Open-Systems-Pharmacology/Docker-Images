...
wget -nv https://github.com/Open-Systems-Pharmacology/TLF-Library/releases/download/v1.2.5/tlf_1.2.5.tar.gz -P /tmp_setup/
...
R CMD INSTALL /tmp_setup/tlf_1.2.5.tar.gz --install-tests && \
